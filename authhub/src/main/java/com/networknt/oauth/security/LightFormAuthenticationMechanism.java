...
/**
 * A customized FormAuthenticationMechanism that allows authenticator and authorizer injection.
 *
 * @author Steve Hu
 */
public class LightFormAuthenticationMechanism implements AuthenticationMechanism {
    ...
    public LightFormAuthenticationMechanism(final FormParserFactory formParserFactory, final String name, final String loginPage, final String errorPage, final String postLocation, final IdentityManager identityManager) {
        this.name = name;
