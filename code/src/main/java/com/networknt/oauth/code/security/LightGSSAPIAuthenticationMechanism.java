 ...
 */
public class LightGSSAPIAuthenticationMechanism implements AuthenticationMechanism {
    ...
    public LightGSSAPIAuthenticationMechanism(final GSSAPIServerSubjectFactory subjectFactory, IdentityManager identityManager, Oid ...supportedMechanisms) {
        this.subjectFactory = subjectFactory;
        this.identityManager = identityManager;
        this.mechanisms = supportedMechanisms;
    }

    public LightGSSAPIAuthenticationMechanism(final GSSAPIServerSubjectFactory subjectFactory, Oid ...supportedMechanisms) {
        this(subjectFactory, null, supportedMechanisms);
    }

    public LightGSSAPIAuthenticationMechanism(final GSSAPIServerSubjectFactory subjectFactory) {
