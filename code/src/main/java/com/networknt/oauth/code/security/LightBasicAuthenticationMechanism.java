...
public class LightBasicAuthenticationMechanism implements AuthenticationMechanism {
    ...
    public static class Factory implements AuthenticationMechanismFactory {
        ...
        public AuthenticationMechanism create(String mechanismName, FormParserFactory formParserFactory, Map<String, String> properties) {
            ...
            return new com.networknt.oauth.code.security.LightBasicAuthenticationMechanism(realm, mechanismName, silent != null && silent.equals("true"), identityManager, charset, userAgentCharsets);
        }
    }
